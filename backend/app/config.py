...
class Settings(BaseSettings):
    ...
    @property
    def normalized_media_storage_provider(self) -> str:
        return self.media_storage_provider.strip().lower() or "local"
    ...
    def local_media_enabled(self) -> bool:
        return (
            ...
            and self.normalized_media_storage_provider == "local"
        )
    ...
    @property
    def production_media_storage_ready(self) -> bool:
        # No durable media provider is implemented yet.
